...
class ManagerScreen(QDialog):
        ...
        try:
            for data in self.market.SearchFood(new_text, date):
                ...
                radio_button.setStyleSheet(
                    'QRadioButton { font: 10pt "MV Boli"; min-height: 20px; min-width: 200px;}'
                )
    ...
    def add_new(self):
        ...
        self.admin.NewNews(text[0:5], text, datetime.date.today().strftime("%Y-%m-%d"))
    ...
    def update_economy(self):
        ...
        for data in all_data:
            ...
            label.setStyleSheet(
                'QLabel { font: 7pt "MV Boli"; min-height: 20px; max-height: 20px; min-width: 200px; }'
            )
        ...
        try:
            ...
            for data in all_data:
                ...
                label.setStyleSheet(
                    'QLabel { font: 12pt "MV Boli"; min-height: 20px; }'
                )
